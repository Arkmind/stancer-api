...
var Payout = /** @class */ (function () {
     ...
     * @throws Error
     */
    Payout.prototype.list = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.get("/v1/payouts", data)];
                    case 1:
                        response = _a.sent();
     ...
     * @throws Error
     */
    Payout.prototype.get = function (id, type, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.get("/v1/payout/".concat(id, "/").concat(type), data)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
