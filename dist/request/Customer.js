...
var Customer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.post("/v1/customer", data)];
                    case 1:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.get("/v1/customer/".concat(id))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
     ...
     * @returns Promise<Customer>
     */
    Customer.prototype.update = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.patch("/v1/customer/".concat(id), data)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.delete("/v1/customer/".concat(id))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                    case 2:
